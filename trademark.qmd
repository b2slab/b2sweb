...
This policy is adapted directly from the Quarto and  WordPress Foundation's [trademark policy](https://wordpressfoundation.org/trademark-policy/) for the Quarto project, WordPress and WordCamp names and logos. We admire the job that WordPress and Quarto has done building a thriving open source community while at the same time making possible a wide variety of WordPress related businesses. We hope that this policy will help us do the same for b2slab.
:::

## Goals

[b2slab](https://b2slab.upc.edu/) owns and oversees the trademark for the b2slab name and logo.  
...
When in doubt about your use of the b2slab name or logo, please contact Posit at [permissions\@b2slab](mailto:alexandre.perera@upc.edu) for clarification.
